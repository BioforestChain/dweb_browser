...
class WebCache: ObservableObject, Identifiable, Hashable, Codable, Equatable{
    ...
    public init(icon: URL? = nil, lastVisitedUrl: URL = testURL, title: String = "", snapshotUrl: URL = URL.defaultSnapshotURL) {
        self.webIconUrl = icon ?? Bundle(for: BrowserManager.self).url(forResource: "Resources.bundle/defWebIcon", withExtension: "png")!
    ...
    required init(from decoder: Decoder) throws {
        ...
        webIconUrl = try container.decodeIfPresent(URL.self, forKey: .webIconUrl) ?? Bundle(for: BrowserManager.self).url(forResource: "Resources.bundle/defWebIcon", withExtension: "png")!//URL.defaultWebIconURL

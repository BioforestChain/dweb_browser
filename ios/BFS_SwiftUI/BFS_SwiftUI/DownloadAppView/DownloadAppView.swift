...
struct DownloadAppView: View {
    ...
    private func loadAppInfo() {
        ...
        guard let url = URL(string: "https://dweb.waterbang.top/bfs-metadata.json") else { return }
...
struct APPModel: Identifiable, Codable {
    ...
    init(id: String, server: [String : String], dweb_deeplinks: [String], icon: String, name: String, short_name: String, description: String, images: [String]? = nil, downloadUrl: String, author: [String]? = nil, version: String, categories: [String]? = nil, new_feature: [String]? = nil, bundle_size: Int, home: String, bundle_hash: String, plugins: [String]? = nil, release_date: String, permissions: [String]? = nil) {
        self.id = id
        self.server = server
    ...
    init(from decoder: Decoder) throws {
        ...
        self.init(id: id ?? "", server: server ?? [:], dweb_deeplinks: dweb_deeplinks ?? [], icon: icon ?? "", name: name ?? "", short_name: short_name ?? "", description: description ?? "", images: images, downloadUrl: downloadUrl ?? "", author: author, version: version ?? "", categories: categories, new_feature: new_feature, bundle_size: bundle_size ?? 0, home: home ?? "", bundle_hash: bundle_hash ?? "", plugins: plugins, release_date: release_date ?? "", permissions: permissions)
    }
}

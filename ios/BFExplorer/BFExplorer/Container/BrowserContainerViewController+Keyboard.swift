...
extension BrowserContainerViewController {
    func setupKeyboardManager() {
        viewModel.setKeyboardHandler(onKeyboardWillShow: { [weak self] notification in
            ...
            self.tabViewControllers[self.currentTabIndex].contentView.homePageView.updateTopAreaStatus()
    ...
    func updateStateForKeyboardDisappearing(needHideSideBar:Bool = true) {
...
//        }
        ...
        self.contentView.addressBarsScrollView.isScrollEnabled = true
    }
...
private extension BrowserContainerViewController {
    ...
    func updateStateForKeyboardAppearing(with keyboardHeight: CGFloat) {
        ...
        self.contentView.addressBarsScrollView.isScrollEnabled = false
    }

...
class BrowserAddressBar: UIView, TextFieldReloadDelegate {
    ...
    func updateStateWhenClicked(link:String){
        textField.text = link
        text = link
        if text!.count > 0{
            showInactiveState()
    ...
    func reloadButtonClicked() {
        self.delegate?.addressBarReloadButtonClicked()
    }
...
//        shadowView.backgroundColor = .cyan
    }

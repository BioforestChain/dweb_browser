...
public struct ImageOption: Codable {
    ...
    var webUseInput: Bool?
    var promptLabelHeader: String?
    var promptLabelCancel: String?
    var promptLabelPhoto: String?
    var promptLabelPicture: String?
    var limit: Int?
}

public struct GalleryImageOption: Codable {
    var quality: Int?
    var width: Int?
    var height: Int?
    var correctOrientation: Bool?
...
public typealias PhotosResult = [String: Any]

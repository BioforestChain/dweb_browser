...
exports.JsIpc = exports.JsMicroModule = exports.NativeMicroModule = exports.$serializeResultToResponse = exports.$deserializeRequestToParams = exports.$typeNameParser = void 0;
...
class MicroModule {
    ...
    registerCommonIpcOnMessageHanlder(common_hanlder_schema) {
        ...
        const custom_handler_schema = {
            ...
            input: (0, exports.$deserializeRequestToParams)(common_hanlder_schema.input),
            output: (0, exports.$serializeResultToResponse)(common_hanlder_schema.output),
        };
        /// 初始化

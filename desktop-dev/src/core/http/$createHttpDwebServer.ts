...
// import type { Ipc, IpcPool } from "../index.ts";
...
//   ) {}
//   private _listenIpcPo = new PromiseOut<Ipc>();
//   private _listenIpcP?: Promise<Ipc>;
//   /** 开始处理请求 */
//   listen = () => {
//     this._listen();
...
//   /// 保存连接对象到池子中
//   await microModule.addToIpcSet(httpServerIpc);

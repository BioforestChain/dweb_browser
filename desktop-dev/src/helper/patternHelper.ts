...
export const fetchMatch = () => {
  ...
  return {
    get(pathname: $PatternPathname, callback: $OnFetch) {
      withList.push([{ method: IPC_METHOD.GET, pathname }, callback]);
      return this;
    },
    post(pathname: $PatternPathname, callback: $OnFetch) {
      withList.push([{ method: IPC_METHOD.POST, pathname }, callback]);
      return this;
    },
    put(pathname: $PatternPathname, callback: $OnFetch) {
      withList.push([{ method: IPC_METHOD.PUT, pathname }, callback]);
      return this;
    },
    delete(pathname: $PatternPathname, callback: $OnFetch) {
      withList.push([{ method: IPC_METHOD.DELETE, pathname }, callback]);
      return this;
    },

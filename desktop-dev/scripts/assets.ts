...
export const assetsTasks = new ConTasks(
  {
    "browser.html": {
      ...
      logLineFilter: (log) => log.includes("../../../../electron/assets/browser/newtab/") === false,
      cwd: "src/browser/browser/assets",
      devAppendArgs: "--minify=false --watch",
    },
    "desktop.html": {
      cmd: "npx",
      args: "vite build --outDir=../../../../electron/assets/browser/desktop --emptyOutDir -l info -c vite.config.ts",
      logLineFilter: (log) => log.includes("../../../../electron/assets/browser/desktop/") === false,
      cwd: "src/browser/desktop/assets",
      devAppendArgs: "--minify=false --watch",
    },
    "jmm.html": {
      cmd: "npx",
      ...
      logLineFilter: (log) => log.includes("../../../../electron/assets/browser/jmm/") === false,
      devAppendArgs: "--minify=false --watch",
    },
    "js-process.worker": {
      cmd: "deno",
    ...
    "js-process.html": {
      ...
      logLineFilter: (log) => log.includes("../../../../electron/assets/browser/js-process/main-thread/") === false,
      devAppendArgs: "--minify=false --watch",
    },
    "bluetooth.html": {
      cmd: "npx",
      ...
      logLineFilter: (log) => log.includes("../../../../electron/assets/std/bluetooth/") === false,
      devAppendArgs: "--minify=false --watch",
    },
    "barcode-scanning.html": {
      ...
      logLineFilter: (log) => log.includes("../../../../electron/assets/sys/barcode-scanning/") === false,
    },
  },
  import.meta.resolve("../")
);

...
inline fun ByteArray.toBase64(): String = this.encodeBase64ToString()
inline fun ByteArray.toUtf8(): String = String(bytes = this, charset = Charsets.UTF_8)
//inline fun ByteArray.toBase64Url(): String = base64UrlEncoder.encodeToString(this)
inline fun ByteArray.toBase64Url(): String = this.encodeBase64UrlToString()
...
inline fun String.fromBase64(): ByteArray = this.decodeBase64ToBytes()!!

...
import info.bagen.kmmsharedmodule.helper.*
...
//            private val IpcUsableIpcBodyMap = WeakHashMap<Ipc, UsableIpcBodyMapper>()
            private val IpcUsableIpcBodyMap = HashMap<Ipc, UsableIpcBodyMapper>()
...
//        private val streamIdWM by lazy { WeakHashMap<InputStream, String>() }
        private val streamIdWM by lazy { HashMap<InputStream, String>() }

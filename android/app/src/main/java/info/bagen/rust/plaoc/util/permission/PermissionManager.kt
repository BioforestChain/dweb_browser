package info.bagen.rust.plaoc.util.permission
...
class PermissionManager {
    ...
    companion object {
        ...
        private val DEFAULT_DENY_DIALOG_TITLE =
            App.appContext.getString(R.string.permission_deny_title)
        ...
        private val DEFAULT_DENY_DIALOG_NEG_BTN =
            App.appContext.getString(R.string.permission_cancel)
    }
}

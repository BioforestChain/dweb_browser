...
class DownLoadRepository(private val api: ApiService = ApiService.instance) {
  ...
  suspend fun saveDownloadState(
    ...
    App.appContext.saveStringSet("download_${downLoadProgress.downloadUrl}", value)
  }
  ...
  suspend fun loadDownloadState(
    ...
    val downLoad = App.appContext.getStringSet("download_$path")
    ...
    App.appContext.remove(key = "download_$path")
  }
}

...
enum class PluginType(
  ...
  DwebServiceWorker("jmm.sys.dweb", "应用管理插件", "下载、更新相关应用操作", Icons.Default.Download),
  FileSystem("file.sys.dweb", "文件管理插件", "管理系统文件", Icons.Default.FileOpen),
  ...
  StatusBar("status-bar.nativeui.sys.dweb", "状态栏插件", "获取状态栏的宽高", Icons.Default.Settings),
  SafeArea("safe-area.nativeui.sys.dweb", "安全区插件", "获取安全区大小", Icons.Default.Camera),
  Torch("torch.nativeui.sys.dweb", "手电筒插件", "打开和关闭手电筒功能", Icons.Default.Light),
  VirtualKeyboard("virtual-keyboard.nativeui.sys.dweb", "虚拟键盘插件", "控制键盘的显示和隐藏", Icons.Default.Keyboard),

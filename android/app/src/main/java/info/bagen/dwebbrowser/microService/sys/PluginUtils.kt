...
enum class PluginType(
  ...
  DwebServiceWorker("jmm.browser.dweb", "应用管理插件", "下载、更新相关应用操作", Icons.Default.Download),
  ...
  StatusBar("status-bar.nativeui.browser.dweb", "状态栏插件", "获取状态栏的宽高", Icons.Default.Settings),
  ...
  VirtualKeyboard("virtual-keyboard.nativeui.browser.dweb", "虚拟键盘插件", "控制键盘的显示和隐藏", Icons.Default.Keyboard),

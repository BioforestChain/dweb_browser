...
val desktopAppList by lazy {
  ...
  list.add(createAppInfo("http://linge.plaoc.com/douban.png", "https://m.douban.com/movie/", "豆瓣"))
  list.add(createAppInfo("http://linge.plaoc.com/zhihu.png", "https://www.zhihu.com/", "知乎"))
  list.add(createAppInfo("http://linge.plaoc.com/bilibili.png", "https://m.bilibili.com/", "哔哩哔哩"))
  list.add(createAppInfo("http://linge.plaoc.com/tencent.png", "https://xw.qq.com/?f=qqcom", "腾讯新闻"))
  list
}

internal fun createAppInfo(icon:String, url:String, name:String) = AppInfo(jmmMetadata = JmmMetadata(
  id = name,

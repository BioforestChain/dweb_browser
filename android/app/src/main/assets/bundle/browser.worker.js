...
async function apiServerOnRequest(ipcRequest, ipc2) {
  ...
  switch (pathname) {
    case (pathname.startsWith("/status-bar.sys.dweb") ? pathname : symbolETO):
      apiServerOnRequestStatusbar(ipcRequest, ipc2, pathname);
      break;
  }
}
async function apiServerOnRequestStatusbar(ipcRequest, ipc2, pathname) {
  switch (pathname) {
    case (pathname.endsWith("setBackgroundColor") ? pathname : symbolETO):
      statusbarSetBackgroundColor(ipcRequest, ipc2);
      break;
  }
}
async function statusbarSetBackgroundColor(ipcRequest, ipc2) {
}

...
if (typeof ImageCapture === "undefined") {
  ImageCapture = class {
    constructor(videoStreamTrack) {
      ...
      this.videoElementPlaying = new Promise((resolve2) => {
        this.videoElement.addEventListener("playing", resolve2);
      });
      if (HTMLMediaElement) {
    ...
    getPhotoCapabilities() {
      return new Promise(function executorGPC(resolve2, reject) {
    ...
    setOptions(photoSettings = {}) {
      return new Promise(function executorSO(resolve2, reject) {
      });
    }
    takePhoto() {
      const self2 = this;
      return new Promise(function executorTP(resolve2, reject) {
        if (self2._videoStreamTrack.readyState !== "live") {
          return reject(new DOMException("InvalidStateError"));
        }
        self2.videoElementPlaying.then(() => {
          try {
            self2.canvasElement.width = self2.videoElement.videoWidth;
            self2.canvasElement.height = self2.videoElement.videoHeight;
            self2.canvas2dContext.drawImage(self2.videoElement, 0, 0);
            self2.canvasElement.toBlob(resolve2);
          } catch (error) {
    ...
    grabFrame() {
      const self2 = this;
      return new Promise(function executorGF(resolve2, reject) {
        if (self2._videoStreamTrack.readyState !== "live") {
          return reject(new DOMException("InvalidStateError"));
        }
        self2.videoElementPlaying.then(() => {
          try {
            ...
            self2.canvasElement.height = self2.videoElement.videoHeight;
            self2.canvas2dContext.drawImage(self2.videoElement, 0, 0);
            resolve2(window.createImageBitmap(self2.canvasElement));
          } catch (error) {
            reject(new DOMException("UnknownError"));
          }
        });
...
class BasePlugin extends HTMLElement {
  ...
  nativeFetch(url, init) {
    ...
    const search = init == null ? void 0 : init.search;
    if (search) {
...
class BarcodeScanner extends BasePlugin {
  ...
  _startVideo() {
    return new Promise(async (resolve2, reject) => {
      ...
      if (!video) {
        ...
        if (((_a = this._options) == null ? void 0 : _a.cameraDirection) !== CameraDirection.BACK) {
  ...
  async _stop() {
    ...
    if (this._video) {
      ...
      await ((_a = this._video.parentElement) == null ? void 0 : _a.remove());
      this._video = null;
    }
  }
}
customElements.define("dweb-scanner", BarcodeScanner);
document.addEventListener("DOMContentLoaded", documentOnDOMContentLoaded$6);
function documentOnDOMContentLoaded$6() {
  const el = new BarcodeScanner();
  document.body.append(el);
  document.removeEventListener("DOMContentLoaded", documentOnDOMContentLoaded$6);
}
...
document.addEventListener("DOMContentLoaded", documentOnDOMContentLoaded$5);
function documentOnDOMContentLoaded$5() {
  const el = new Navigatorbar();
  document.body.append(el);
  document.removeEventListener("DOMContentLoaded", documentOnDOMContentLoaded$5);
}
class ToastPlugin extends BasePlugin {
...
document.addEventListener("DOMContentLoaded", documentOnDOMContentLoaded$4);
function documentOnDOMContentLoaded$4() {
  const el = new ToastPlugin();
  document.body.append(el);
  document.removeEventListener("DOMContentLoaded", documentOnDOMContentLoaded$4);
}
class TorchPlugin extends BasePlugin {
...
document.addEventListener("DOMContentLoaded", documentOnDOMContentLoaded$3);
function documentOnDOMContentLoaded$3() {
  const el = new TorchPlugin();
  document.body.append(el);
  document.removeEventListener("DOMContentLoaded", documentOnDOMContentLoaded$3);
}
...
const StatusBarAnimation = EStatusBarAnimation;
...
class StatusbarPlugin extends BasePlugin {
  ...
  async setBackgroundColor(options) {
    var _a;
    const colorHex = convertToRGBAHex((_a = options.color) != null ? _a : "");
  ...
  async show(options) {
    var _a;
    const animation = (_a = options == null ? void 0 : options.animation) != null ? _a : EStatusBarAnimation.None;
...
document.addEventListener("DOMContentLoaded", documentOnDOMContentLoaded$2);
function documentOnDOMContentLoaded$2() {
  const el = new StatusbarPlugin();
  document.body.append(el);
  document.removeEventListener("DOMContentLoaded", documentOnDOMContentLoaded$2);
}
class SplashScreenPlugin extends BasePlugin {
  ...
  async show(options) {
    return await this.nativeFetch(`/show`, {
      search: {
        autoHide: options == null ? void 0 : options.autoHide,
        showDuration: options == null ? void 0 : options.showDuration,
        fadeOutDuration: options == null ? void 0 : options.fadeOutDuration,
        fadeInDuration: options == null ? void 0 : options.fadeInDuration
      }
    });
  }
  async hide(options) {
...
document.addEventListener("DOMContentLoaded", documentOnDOMContentLoaded$1);
function documentOnDOMContentLoaded$1() {
  const el = new SplashScreenPlugin();
  document.body.append(el);
  document.removeEventListener("DOMContentLoaded", documentOnDOMContentLoaded$1);
}
class SharePlugin extends BasePlugin {
  ...
  async share(options) {
    return await this.nativeFetch(`/share`, {
      search: {
        dialogTitle: options == null ? void 0 : options.dialogTitle,
        title: options == null ? void 0 : options.title,
        text: options == null ? void 0 : options.text,
        url: options == null ? void 0 : options.url,
        files: options == null ? void 0 : options.files
      }
    });
  }
}
...
var bfexPlugin = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  get SupportedFormat() {
  ...
  BarcodeScanner,
  get NavigationBarPluginEvents() {
    return NavigationBarPluginEvents;
  },
  get NAVIGATION_BAR_COLOR() {
  ...
  get EStatusBarAnimation() {
    return EStatusBarAnimation;
  },
  StatusBarAnimation,
  StatusBarStyle,
  StatusbarPlugin,
...
const _withScopeId = (n) => (pushScopeId("data-v-daf7e18e"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "drawer h-full app-bg" };
const _hoisted_2 = { class: "drawer-content flex flex-col" };
const _hoisted_3 = /* @__PURE__ */ createStaticVNode('<div class="navbar" data-v-daf7e18e><div class="flex-none" data-v-daf7e18e><label for="my-drawer-controller" class="btn btn-square btn-ghost" data-v-daf7e18e><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-6 h-6 stroke-current" data-v-daf7e18e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-daf7e18e></path></svg></label></div><div class="flex-1" data-v-daf7e18e><h1 class="text-xl" data-v-daf7e18e>JMM Plugins Demo</h1></div><div class="flex-none" data-v-daf7e18e><button class="btn btn-square btn-ghost" data-v-daf7e18e><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-5 h-5 stroke-current" data-v-daf7e18e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" data-v-daf7e18e></path></svg></button></div></div>', 1);
const _hoisted_4 = { class: "p-4" };
const _hoisted_5 = { class: "drawer-side" };
const _hoisted_6 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("label", {
  for: "my-drawer-controller",
  class: "drawer-overlay"
}, null, -1));
const _hoisted_7 = { class: "menu p-4 w-80 glass bg-base-100 bg-opacity-50" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "App",
  props: { routes: Array },
  setup(__props) {
    const routes = [
      { path: "/haptics", title: "Haptics" },
      { path: "/keyboard", title: "Keyboard" },
      { path: "/navigationbar", title: "Navigation Bar" },
      { path: "/safearea", title: "Safe Area" },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        withDirectives(createBaseVNode("input", {
          id: "my-drawer-controller",
          type: "checkbox",
          class: "drawer-toggle",
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => drawer_controller.value = $event)
        }, null, 512), [
          [vModelCheckbox, drawer_controller.value]
        ]),
...
var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-daf7e18e"]]);
var app = "";
...
createApp(App).use(
  createRouter({
    ...
    routes: [
      { path: "/haptics", component: () => __vitePreload(() => import("./Haptics.67e7e4ca.js"), true ? ["assets/Haptics.67e7e4ca.js","assets/FieldLabel.4b697f2e.js","assets/FieldLabel.72137d27.css"] : void 0) },
      { path: "/keyboard", component: () => __vitePreload(() => import("./Keyboard.89b4086c.js"), true ? [] : void 0) },
      { path: "/navigationbar", component: () => __vitePreload(() => import("./NavigationBar.87fd7e91.js"), true ? [] : void 0) },
      { path: "/safearea", component: () => __vitePreload(() => import("./SafeArea.0d77cc4a.js"), true ? [] : void 0) },
      { path: "/share", component: () => __vitePreload(() => import("./Share.93d95b84.js"), true ? ["assets/Share.93d95b84.js","assets/FieldLabel.4b697f2e.js","assets/FieldLabel.72137d27.css"] : void 0) },
      { path: "/splashscreen", component: () => __vitePreload(() => import("./SplashScreen.5d8125e4.js"), true ? ["assets/SplashScreen.5d8125e4.js","assets/FieldLabel.4b697f2e.js","assets/FieldLabel.72137d27.css"] : void 0) },
      { path: "/statusbar", component: () => __vitePreload(() => import("./StatusBar.5225c7e3.js"), true ? [] : void 0) },
      { path: "/toast", component: () => __vitePreload(() => import("./Toast.719dbff5.js"), true ? ["assets/Toast.719dbff5.js","assets/Toast.8fbd081d.css","assets/FieldLabel.4b697f2e.js","assets/FieldLabel.72137d27.css"] : void 0) }
    ]
  })
).mount("#app");
export { Fragment as F, TransitionGroup as T, _export_sfc as _, createBaseVNode as a, createVNode as b, createElementBlock as c, defineComponent as d, renderSlot as e, createStaticVNode as f, renderList as g, onMounted as h, withDirectives as i, vModelSelect as j, resolveComponent as k, normalizeClass as n, openBlock as o, ref as r, toDisplayString as t, vModelText as v, withCtx as w };

...
class MediaVideoViewController : UIViewController(nibName = null, bundle = null) {
    ...
    private fun initVideoLayer() {
        ...
        videoLayer.setFrame(CGRectMake(
            0.0,
            naviHeight,
    ...
    private val delegate = object : NSObject(), AVCaptureFileOutputRecordingDelegateProtocol {
        ...
        override fun captureOutput(
            ...
            PHPhotoLibrary.sharedPhotoLibrary().performChanges({
                PHAssetChangeRequest.creationRequestForAssetFromVideoAtFileURL(didFinishRecordingToOutputFileAtURL)
            }) { isSuccess, err ->
                if (isSuccess) {
                    message = "保存成功"
                } else {

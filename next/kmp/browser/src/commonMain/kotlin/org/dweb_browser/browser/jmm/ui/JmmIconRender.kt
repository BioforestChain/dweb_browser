...
@Composable
fun JmmAppInstallManifest.IconRender(size: Dp = LocalTextStyle.current.fontSize.value.let { if (it.isNaN()) 32f else it * 2 }.dp) {
  val fetchHook = LocalWindowMM.current.blobFetchHook

...
suspend fun MicroModule.Runtime.getEngineHomeLink(key: String) =
  nativeFetch("file://search.browser.dweb/homeLink?key=$key").text()

suspend fun MicroModule.Runtime.getInjectList(key: String) =
...
suspend fun NativeMicroModule.NativeRuntime.collectChannelOfEngines(collector: suspend WatchSearchEngineContext.() -> Unit) =

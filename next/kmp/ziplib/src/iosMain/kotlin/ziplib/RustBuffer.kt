...
actual typealias RustBuffer = CValue<ziplib.cinterop.RustBuffer>
@Suppress("ACTUAL_WITHOUT_EXPECT", "ACTUAL_TYPE_ALIAS_WITH_COMPLEX_SUBSTITUTION")
actual typealias RustBufferPointer = CPointer<ziplib.cinterop.RustBuffer>
...
actual fun allocRustBuffer(buffer: Buffer): RustBuffer =
    rustCall { status ->
        ...
        UniFFILib.ffi_ziplib_d872_rustbuffer_alloc(size.toInt(), status).also {
            it.useContents {

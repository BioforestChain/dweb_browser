    ...
    override suspend fun _bootstrap(bootstrapContext: BootstrapContext) {
        routes(/** 检查识别支持生物识别*/
            "/check" bind HttpMethod.Get to defineBooleanResponse {
                ...
                val isSupport = BiometricsManage.isSupportBiometrics(ipc,request)
                return@defineBooleanResponse isSupport
            },
            /** 生物识别*/
            "/biometrics" bind HttpMethod.Get to defineJsonResponse {
                val biometricsResult = BiometricsManage.biometricsResultContent(ipc)

...
// src/helper/$makeFetchBaseExtends.ts
...
// src/helper/$makeFetchStreamExtends.ts
...
// src/helper/$makeFetchExtends.ts
var fetchExtends = {
  ...fetchBaseExtends,
  ...fetchStreamExtends
};
...
// src/sys/dns/nativeFetch.ts
var nativeFetchAdaptersManager = new AdaptersManager();

// src/core/micro-module.ts
...
// src/core/ipc/IpcRequest.ts
var import_lodash = __toESM(require_lodash());

// src/helper/readableStreamHelper.ts
...
var _IpcRequest = class extends IpcMessage {
  constructor(req_id, url, method, headers, body, ipc) {
    ...
    this.ipcReqMessage = (0, import_lodash.once)(
      () => new IpcReqMessage(
        this.req_id,
        this.method,
        this.url,
...
var _IpcResponse = class extends IpcMessage {
  constructor(req_id, statusCode, headers, body, ipc) {
    ...
    this.ipcResMessage = (0, import_lodash2.once)(
      () => new IpcResMessage(
        this.req_id,
        this.statusCode,
        this.headers.toJSON(),
...
// src/core/ipc/IpcStreamAbort.ts
...
// src/core/ipc/IpcStreamPulling.ts
...
// src/core/ipc/IpcBodyReceiver.ts
...
// src/core/ipc/IpcStreamPaused.ts
...
// src/core/ipc-web/$messageToIpcMessage.ts
...
// src/core/ipc-web/$messagePackToIpcMessage.ts
...
// src/core/ipc-web/MessagePortIpc.ts
...
// src/sys/http-server/$createHttpDwebServer.ts
...
// src/core/ipc-web/ReadableStreamIpc.ts
...
var ReadableStreamIpc = class extends Ipc {
  constructor(remote, role, self_support_protocols = {
    ...
    this.PONG_DATA = (0, import_lodash3.once)(() => {
...
var HttpDwebServer = class {
  constructor(nmm, options, startResult) {
    ...
    /** 关闭监听 */
    this.close = (0, import_lodash4.once)(() => closeHttpDwebServer(this.nmm, this.options));
  }
};
...
// src/sys/js-process/js-process.worker.ts
var Metadata = class {

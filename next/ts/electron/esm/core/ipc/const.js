...
export const toIpcMethod = (method) => {
    if (method == null) {
...
export const $dataToBinary = (data, encoding) => {
    switch (encoding) {
...
export const $dataToText = (data, encoding) => {
    switch (encoding) {
        case IPC_DATA_ENCODING.BINARY: {

...
import { httpMethodCanOwnBody } from "../../helper/httpMethodCanOwnBody.js";
import { ReadableStreamOut, streamFromCallback, streamRead, streamReadAll, } from "../../helper/readableStreamHelper.js";
...
export class PortListener {
    ...
    async hookHttpRequest(req, res) {
        ...
        //   : true
            ...
            const server_req_body_writter = new ReadableStreamOut();
            ;
            (async () => {
                ...
                for await (const _ of streamRead(streamFromCallback(server_req_body_writter.onPull, client_req_body_reader.closed))) {

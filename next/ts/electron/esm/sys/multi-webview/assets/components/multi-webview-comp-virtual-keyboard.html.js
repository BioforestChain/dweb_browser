...
let MultiWebviewCompVirtualKeyboard = class MultiWebviewCompVirtualKeyboard extends LitElement {
    constructor() {
        super(...arguments);
    ...
    render() {
      ...
      >
          ...
          <div class="row line-3">
            ${repeat(this.row3Keys, this.repeatGetKey, this.createElementForRow3.bind(this, "key-symbol", "key-alphabet"))}
          </div> 
          <div class="row line-4">
            ${repeat(this.row4Keys, this.repeatGetKey, this.createElementForRow4.bind(this, "key-symbol", "key-space", "key-search"))}
          </div> 
      </div>
    `;
    }
...
MultiWebviewCompVirtualKeyboard = __decorate([
    customElement('multi-webview-comp-virtual-keyboard')
], MultiWebviewCompVirtualKeyboard);
export { MultiWebviewCompVirtualKeyboard };

...
import { hexaToRGBA } from "../../../plugins/helper.js";
let MultiWebviewCompNavigationBar = class MultiWebviewCompNavigationBar extends LitElement {
    constructor() {
        super(...arguments);
...
export { MultiWebviewCompNavigationBar };

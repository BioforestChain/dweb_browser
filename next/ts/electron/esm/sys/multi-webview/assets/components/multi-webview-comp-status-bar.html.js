...
let MultiWebviewCompStatusBar = class MultiWebviewCompStatusBar extends LitElement {
    constructor() {
        super(...arguments);
    ...
    render() {
      ...
      <div class="comp-container">
        ...
        <div class="container" style=${styleMap(containerStyleMap)}>
          ${when(this._visible, () => html `<div class="left_container">10:00</div>`, () => html ``)}
          <div class="center_container">
            ${when(this._torchIsOpen, () => html `<div class="torch_symbol"></div>`, () => html ``)}
          </div>
          ${when(this._visible, () => html `
...
export { MultiWebviewCompStatusBar };

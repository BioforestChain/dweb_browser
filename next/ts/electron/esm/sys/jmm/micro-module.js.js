...
import { IPC_ROLE, IpcResponse } from "../../core/ipc/index.js";
import { MicroModule } from "../../core/micro-module.js";
import { buildUrl } from "../../helper/urlHelper.js";
import { Native2JsIpc } from "../js-process/ipc.native2js.js";
/**
...
export class JsMicroModule extends MicroModule {
    ...
    async _bootstrap(context) {
        ...
        // 创建一个 streamIpc
        void streamIpc.bindIncomeStream(this.nativeFetch(buildUrl(new URL(`file://js.sys.dweb/create-process`), {
            search: {
        ...
        jsIpc.onEvent(async (ipcEvent) => {
            ...
            if (ipcEvent.name === "dns/connect") {
                ...
                const portId = await this.nativeFetch(buildUrl(new URL(`file://js.sys.dweb/create-ipc`), {

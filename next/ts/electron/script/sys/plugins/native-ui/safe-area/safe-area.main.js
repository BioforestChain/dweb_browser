...
class SafeAreaNMM extends micro_module_native_js_1.NativeMicroModule {
    constructor() {
        super(...arguments);
        Object.defineProperty(this, "mmid", {
            ...
            configurable: true,
            writable: true,
            value: "safe-area.nativeui.sys.dweb"
        });
        ...
        Object.defineProperty(this, "_bootstrap", {
            ...
            value: async (context) => {
                devtools_js_1.log.green(`[${this.mmid} _bootstrap]`);
                {
                    ...
                    electron_1.ipcMain.on('safe_area_update', (ipcMainEvent, host, state) => {
                        ...
                        if (b === true) {
                            ...
                            ipc.postMessage(IpcEvent_js_1.IpcEvent.fromText("observe", `${JSON.stringify(state)}`));
                        }
                    });
                }
...
exports.SafeAreaNMM = SafeAreaNMM;

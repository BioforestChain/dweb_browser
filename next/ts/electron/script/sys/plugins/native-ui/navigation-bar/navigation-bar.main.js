...
exports.NavigationBarNMM = void 0;
// 模拟状态栏模块-用来提供状态UI的模块
...
class NavigationBarNMM extends micro_module_native_js_1.NativeMicroModule {
    constructor() {
        super(...arguments);
        ...
        Object.defineProperty(this, "_bootstrap", {
            ...
            value: async (context) => {
                devtools_js_1.log.green(`[${this.mmid} _bootstrap]`);
                {
                    ...
                    electron_1.ipcMain.on('navigation_bar_state_change', (ipcMainEvent, host, statusbarState) => {
...
exports.NavigationBarNMM = NavigationBarNMM;

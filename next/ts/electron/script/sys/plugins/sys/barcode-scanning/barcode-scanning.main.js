...
exports.BarcodeScanningNativeUiNMM = void 0;
// 模拟状态栏模块-用来提供状态UI的模块
...
class BarcodeScanningNativeUiNMM extends micro_module_native_js_1.NativeMicroModule {
    constructor() {
        super(...arguments);
            ...
            value: async (context) => {
                ...
                this.registerCommonIpcOnMessageHandler({
                    ...
                    handler: async (args, client_ipc, ipcRequest) => {
                        ...
                        // 直接解析二维码
                        return await jimp_1.default.read(await ipcRequest.body.u8a()).then(({ bitmap }) => {
                            const result = (0, jsqr_1.default)(bitmap.data, bitmap.width, bitmap.height);
        ...
        Object.defineProperty(this, "_processPOST", {
            ...
            value: async (req, res) => {
                ...
                req.on("end", () => {
                    jimp_1.default.read(chunks).then(({ bitmap }) => {
                        const result = (0, jsqr_1.default)(bitmap.data, bitmap.width, bitmap.height);
...
exports.BarcodeScanningNativeUiNMM = BarcodeScanningNativeUiNMM;

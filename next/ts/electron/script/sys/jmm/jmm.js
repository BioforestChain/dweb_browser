...
exports.DOWNLOAD_STATUS = exports.JmmNMM = void 0;
const micro_module_native_js_1 = require("../../core/micro-module.native.js");
const devtools_js_1 = require("../../helper/devtools.js");
const JmmMetadata_js_1 = require("./JmmMetadata.js");
const micro_module_js_js_1 = require("./micro-module.js.js");
const jmm_handler_js_1 = require("./jmm.handler.js");
const jmm_www_serve_js_1 = require("./jmm.www.serve.js");
const jmm_api_serve_js_1 = require("./jmm.api.serve.js");
class JmmNMM extends micro_module_native_js_1.NativeMicroModule {
    constructor() {
        super(...arguments);
    ...
    async _bootstrap(context) {
        ...
        await jmm_www_serve_js_1.createWWWServer.bind(this)();
        await jmm_api_serve_js_1.createApiServer.bind(this)();
        //  安装 第三方 app
        this.registerCommonIpcOnMessageHandler({
            ...
            output: "boolean",
            handler: jmm_handler_js_1.install.bind(this),
        });
        // 下载暂停
        this.registerCommonIpcOnMessageHandler({
            pathname: "/pause",
            ...
            input: {},
            output: "boolean",
            handler: jmm_handler_js_1.pause.bind(this),
        });
        this.registerCommonIpcOnMessageHandler({
            pathname: "/resume",
            matchMode: "full",
            input: {},
            output: "boolean",
            handler: jmm_handler_js_1.resume.bind(this),
        });
        this.registerCommonIpcOnMessageHandler({
            pathname: "/cancel",
            matchMode: "full",
            input: {},
            output: "boolean",
            handler: jmm_handler_js_1.cancel.bind(this),
        });
        // this.registerCommonIpcOnMessageHandler({
        //   pathname: "/open_page",
        //   matchMode: "full",
    ...
    async openInstallPage(metadataUrl) {
        ...
        // TODO 打开安装页面
        /// 成功安装
        new micro_module_js_js_1.JsMicroModule(new JmmMetadata_js_1.JmmMetadata(config));
        return config;
    }
}
exports.JmmNMM = JmmNMM;
// $AppMetaData 的实例 {
//   title: 'cotdemo',
//   subtitle: 'cotdemo',
//   id: 'cotdemo.bfs.dweb',
...
})(DOWNLOAD_STATUS = exports.DOWNLOAD_STATUS || (exports.DOWNLOAD_STATUS = {}));

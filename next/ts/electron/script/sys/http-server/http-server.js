...
const Http1Server_js_1 = require("./net/Http1Server.js");
const portListener_js_1 = require("./portListener.js");
const devtools_js_1 = require("../../helper/devtools.js");
/**
 * 类似 https.createServer
 * 差别在于服务只在本地运作
 */
class HttpServerNMM extends micro_module_native_js_1.NativeMicroModule {
    constructor() {
        super(...arguments);
        ...
        Object.defineProperty(this, "_dwebServer", {
            ...
            configurable: true,
            writable: true,
            value: new Http1Server_js_1.Http1Server()
        });
        ...
        this._info.server.on("request", async (req, res) => {
            ...
            const host = this.getHostByReq(req);
            {
                ...
                if (gateway == undefined) {
                    devtools_js_1.log.red(`[http-server onRequest 既没分发也没有匹配 gatewaty请求] ${req.url}`);
                    return (0, defaultErrorResponse_js_1.defaultErrorResponse)(req, res, 502, "Bad Gateway", "作为网关或者代理工作的服务器尝试执行请求时，从远程服务器接收到了一个无效的响应");
                }
    ...
    getServerUrlInfo(ipc, options) {
        ...
        return new const_js_2.ServerUrlInfo(host, internal_origin, public_origin);
    }
    /** 申请监听，获得一个连接地址 */
    async start(ipc, hostOptions) {
        ...
        const listener = new portListener_js_1.PortListener(ipc, serverUrlInfo.host, serverUrlInfo.internal_origin);
        ...
        // jmmmetadata.sys.dweb-80.localhost:22605
        const token = Buffer.from(crypto_1.default.getRandomValues(new Uint8Array(64))).toString("base64url");
    ...
    async listen(token, message, routes) {
        ...
        const streamIpc = new ReadableStreamIpc_js_1.ReadableStreamIpc(gateway.listener.ipc.remote, const_js_1.IPC_ROLE.CLIENT);
...
exports.HttpServerNMM = HttpServerNMM;

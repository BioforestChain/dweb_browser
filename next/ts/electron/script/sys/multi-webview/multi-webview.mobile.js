...
const locksManager_js_1 = require("../../helper/locksManager.js");
...
const multi_webview_mobile_handler_js_1 = require("./multi-webview.mobile.handler.js");
/**
 * 构建一个视图树
...
class MultiWebviewNMM extends micro_module_native_js_1.NativeMicroModule {
    constructor() {
        ...
        Object.defineProperty(this, "_uid_wapis_map", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
    ...
    async _bootstrap(context) {
        ...
        (await httpDwebServer.listen()).onRequest(async (request, ipc) => {
            ipc.postMessage(await IpcResponse_js_1.IpcResponse.fromResponse(request.req_id, await this.nativeFetch("file:///bundle/multi-webview" + request.parsed_url.pathname), ipc));
        });
        const root_url = httpDwebServer.startResult.urlInfo.buildInternalUrl((url) => {
        ...
        this.registerCommonIpcOnMessageHandler({
            ...
            input: { url: "string" },
            output: "number",
            handler: multi_webview_mobile_handler_js_1.open.bind(this, root_url),
        });
        ...
        this.registerCommonIpcOnMessageHandler({
            ...
            input: { url: "string" },
            output: "object",
            handler: multi_webview_mobile_handler_js_1.openDownloadPage.bind(this, root_url)
        });
        ...
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "boolean",
            handler: multi_webview_mobile_handler_js_1.closeFocusedWindow.bind(this, root_url)
        });
        // 销毁指定的 webview
        this.registerCommonIpcOnMessageHandler({
        ...
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.barGetState.bind(this, "statusBarGetState", root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.barSetState.bind(this, "statusBarSetState", root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.barGetState.bind(this, "navigationBarGetState", root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.barSetState.bind(this, "navigationBarSetState", root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.safeAreaGetState.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.safeAreaSetState.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.virtualKeyboardGetState.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.virtualKeyboardSetState.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.toastShow.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "object",
            handler: multi_webview_mobile_handler_js_1.shareShare.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "boolean",
            handler: multi_webview_mobile_handler_js_1.toggleTorch.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "boolean",
            handler: multi_webview_mobile_handler_js_1.torchState.bind(this, root_url)
        });
        ...
        this.registerCommonIpcOnMessageHandler({
            ...
            input: { action: "string" },
            output: "boolean",
            handler: multi_webview_mobile_handler_js_1.haptics.bind(this, root_url)
        });
        this.registerCommonIpcOnMessageHandler({
            ...
            input: {},
            output: "boolean",
            handler: multi_webview_mobile_handler_js_1.biometricsMock.bind(this, root_url)
        });
    }
    ...
    forceGetWapis(ipc, root_url) {
        return locksManager_js_1.locks.request("multi-webview-get-window-" + ipc.uid, async () => {
            let wapi = this._uid_wapis_map.get(ipc.uid);
            if (wapi === undefined) {
                const nww = await (0, openNativeWindow_js_1.openNativeWindow)(root_url, {
                    webPreferences: {
                        webviewTag: true,
                    },
                ...
                const apis = nww.getApis();
                const absolutePath = "file://" + path_1.default.resolve(__dirname, "./assets/preload.cjs");
...
function getOriginByReq(req) {
    return req.headers.origin ?? new URL(req.headers.referer).origin;
}

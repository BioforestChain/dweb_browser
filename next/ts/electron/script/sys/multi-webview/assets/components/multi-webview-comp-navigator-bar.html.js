...
exports.MultiWebviewCompNavigationBar = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const style_map_js_1 = require("lit/directives/style-map.js");
const electron_1 = require("electron");
const helper_js_1 = require("../../../plugins/helper.js");
let MultiWebviewCompNavigationBar = class MultiWebviewCompNavigationBar extends lit_1.LitElement {
    constructor() {
        super(...arguments);
    ...
    updated(_changedProperties) {
        ...
        if (attributes.includes('_visible')
    ...
    render() {
      ...
      <div class="container">
        ...
        <div 
          ...
          style=${(0, style_map_js_1.styleMap)(containerStyleMap)}  
        >
...
Object.defineProperty(MultiWebviewCompNavigationBar, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: createAllCSS()
...
], MultiWebviewCompNavigationBar.prototype, "_color", void 0);
__decorate([
    (0, decorators_js_1.property)({ type: String })
], MultiWebviewCompNavigationBar.prototype, "_style", void 0);
__decorate([
    (0, decorators_js_1.property)({ type: Boolean })
], MultiWebviewCompNavigationBar.prototype, "_overlay", void 0);
__decorate([
    (0, decorators_js_1.property)({ type: Boolean })
], MultiWebviewCompNavigationBar.prototype, "_visible", void 0);
__decorate([
    (0, decorators_js_1.property)({ type: Object })
], MultiWebviewCompNavigationBar.prototype, "_insets", void 0);
__decorate([
    (0, decorators_js_1.property)()
], MultiWebviewCompNavigationBar.prototype, "_webview_src", void 0);
MultiWebviewCompNavigationBar = __decorate([
    (0, decorators_js_1.customElement)("multi-webview-comp-navigation-bar")
], MultiWebviewCompNavigationBar);
exports.MultiWebviewCompNavigationBar = MultiWebviewCompNavigationBar;

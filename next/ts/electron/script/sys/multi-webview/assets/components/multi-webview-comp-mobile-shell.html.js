...
exports.MultiWebViewCompMobileShell = void 0;
/**
 * app 容器组件
 * - status-bar
 * - ...其他插件都在这里注入
...
let MultiWebViewCompMobileShell = class MultiWebViewCompMobileShell extends lit_1.LitElement {
    constructor() {
        super(...arguments);
...
__decorate([
    (0, decorators_js_2.query)('.app_content_container')
], MultiWebViewCompMobileShell.prototype, "appContentContainer", void 0);
MultiWebViewCompMobileShell = __decorate([
    (0, decorators_js_1.customElement)("multi-webview-comp-mobile-shell")
], MultiWebViewCompMobileShell);
exports.MultiWebViewCompMobileShell = MultiWebViewCompMobileShell;

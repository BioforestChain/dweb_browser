...
public class IpcMessage
{
    ...
    public virtual string ToJson() => JsonSerializer.Serialize(this, new JsonSerializerOptions { IncludeFields = true, PropertyNameCaseInsensitive = true });
    ...
    public static IpcMessage? FromJson(string json) => JsonSerializer.Deserialize<IpcMessage>(json, new JsonSerializerOptions { IncludeFields = true, PropertyNameCaseInsensitive = true });
}

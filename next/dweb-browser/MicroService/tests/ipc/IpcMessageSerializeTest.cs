...
public class IpcMessageSerializeTest
{
    ...
    //{
    //Debug.WriteLine(IpcStreamAbort.FromJson(@"{""type"":6,""stream_id"":""stream_id""}"));
    //Debug.WriteLine(new IpcStreamAbort("stream_id").ToJson());
    //Debug.WriteLine(IpcStreamAbort.FromJson(new IpcStreamAbort("stream_id").ToJson()));
    //Debug.WriteLine(JsonSerializer.Deserialize<IpcMessageType>(@"{""type"":6,""stream_id"":""stream_id""}"));
    //}
    ...
    {
        //Debug.WriteLine(MessagePack.MessagePackSerializer.ConvertToJson(new byte[] {
        //              130, 164, 116, 121, 112, 101, 6, 169, 115, 116, 114,
        //              101, 97, 109, 95, 105, 100, 169, 115, 116, 114, 101,
        //              97, 109, 95, 105, 100 }));

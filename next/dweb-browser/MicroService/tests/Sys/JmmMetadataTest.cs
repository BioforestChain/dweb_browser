...
public class JmmMetadataTest
{
    ...
    //        server: new JmmMetadata.MainServer() { Root = "file:///jmm", Entry = "/cot.worker.js" },
    ...
    //        splashScreen: new JmmMetadata.SSplashScreen()
    //    );

    //[Fact]
    //public void JmmMetadata_Serialize_ReturnSuccess()
    //{
    //    Debug.WriteLine(jmmMetadata.ToJson());
    //    Assert.IsType<string>(jmmMetadata.ToJson());
    //}

    //[Fact]
    //public void JmmMetadata_Deserialize_ReturnSuccess()
    //{
    //    Debug.WriteLine(JmmMetadata.FromJson(jmmMetadata.ToJson()));
    //    Assert.IsType<JmmMetadata>(JmmMetadata.FromJson(jmmMetadata.ToJson()));
    //}
}

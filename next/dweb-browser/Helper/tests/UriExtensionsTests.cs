...
namespace DwebBrowser.HelperTests
{
    ...
    {
        [Theory]
        [InlineData("https://js.browser.dweb:80/%3cinternal%3e/bootstrap.js")]
        ...
        [Theory]
        [InlineData("https://js.browser.dweb:80/", "%2f%3cinternal%3e/bootstrap.js")]
        public void Path_Replace_ReturnSuccess(string url, string path)
        {
            ...
            Assert.Equal(
                new Uri("https://js.browser.dweb:80/%3cinternal%3e/bootstrap.js"),

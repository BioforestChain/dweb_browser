...
const fetchBaseExtends = $makeExtends()({
  async number() {
...
const fetchStreamExtends = $makeExtends()({
  async jsonlines(parser) {
    return (await this.stream()).pipeThrough(new TextDecoderStream()).pipeThrough(new JsonlinesStream(parser));
  },
  stream() {
...
class BasePlugin {
  ...
  buildRequest(url, init) {
    ...
    if (search) {
      ...
      if (search instanceof URLSearchParams) {
        ...
        extendsSearch = new URLSearchParams(Object.entries(search).filter(([_, value]) => value != void 0).map(([key, value]) => {
          return [
            key,
  ...
  buildApiRequest(pathname, init) {
    var _a3;
    const url = new URL((_a3 = init == null ? void 0 : init.base) != null ? _a3 : BasePlugin.internal_url);
    url.pathname = `${this.mmid}${pathname}`;
    return this.buildRequest(url, init);
  }
  buildInternalApiRequest(pathname, init) {
    var _a3;
    const url = new URL((_a3 = init == null ? void 0 : init.base) != null ? _a3 : BasePlugin.internal_url);
...
Object.defineProperty(BasePlugin, "internal_url", {
  enumerable: true,
  configurable: true,
  writable: true,
  value: (_b = (_a2 = globalThis.location) == null ? void 0 : _a2.href) != null ? _b : "http://localhost"
});
Object.defineProperty(BasePlugin, "public_url", {
  enumerable: true,
  configurable: true,
  writable: true,
  value: ""
...
const bindThis = (target, prop, desp) => {
...
function convertColorToArga(color) {
  var _a3;
  const rgbaColor = [0, 0, 0, 255];
  if (color.startsWith("rgb")) {
    const colorArr = (_a3 = color.match(/\((.+)\)/)) == null ? void 0 : _a3[1].match(/\d+/g);
    if (colorArr) {
...
var COLOR_FORMAT;
(function(COLOR_FORMAT2) {
  COLOR_FORMAT2[COLOR_FORMAT2["HEXA"] = 0] = "HEXA";
  COLOR_FORMAT2[COLOR_FORMAT2["RGBA"] = 1] = "RGBA";
})(COLOR_FORMAT || (COLOR_FORMAT = {}));
function normalizeArgaToColor(color, format = COLOR_FORMAT.RGBA) {
  const rgbaColor = [color.red, color.green, color.blue, color.alpha];
  if (format === COLOR_FORMAT.HEXA) {
    const hex = "#" + rgbaColor.map((v) => (v & 255).toString(16).padStart(2, "0")).join("").toUpperCase();
    if (hex.endsWith("ff")) {
      return hex.slice(0, -2);
    }
    return hex;
  }
  return `rgba(${rgbaColor.map((v, index) => {
    if (index === 3) {
      return v / 255;
    }
    return v;
...
const insetsToDom = (insets) => new DOMInsets(insets.left, insets.top, insets.right, insets.bottom);
const domInsetsToJson = (domInsets) => ({
  left: domInsets.left,
  top: domInsets.top,
...
class DOMInsets {
  ...
  toCssText(options) {
    return this.toCss(options).map(([key, value]) => `${key}:${value};`).join(" ");
  }
  ...
  effect(options) {
    var _a3, _b2, _c2, _d2;
    const eleId = (_d2 = (_c2 = (_a3 = options.css_var_prefix) == null ? void 0 : _a3.concat("<<prefix")) != null ? _c2 : (_b2 = options.css_var_name) == null ? void 0 : _b2.concat("<<name")) != null ? _d2 : "default";
...
const formatInsetsToCssOptions = (options = {}) => {
  var _a3, _b2;
  const css_var_prefix = (_a3 = options.css_var_prefix) != null ? _a3 : options.css_var_name ? `--${options.css_var_name}-inset-` : `--inset-`;
  const density = (_b2 = options.density) != null ? _b2 : globalThis.devicePixelRatio;
...
class StateObserver {
  constructor(plugin, fetcher, coder) {
    Object.defineProperty(this, "plugin", {
      enumerable: true,
      configurable: true,
      writable: true,
  ...
  async *jsonlines(options) {
    const jsonlines = await this.plugin.buildInternalApiRequest("/observe", {
      search: { mmid: this.plugin.mmid },
      base: await BasePlugin.public_url
    }).fetch().jsonlines(this.coder.decode);
  ...
  async getState(force_update = false) {
    if (force_update || this.currentState === void 0) {
...
var BAR_STYLE;
(function(BAR_STYLE2) {
  BAR_STYLE2["Dark"] = "DARK";
  BAR_STYLE2["Light"] = "LIGHT";
  BAR_STYLE2["Default"] = "DEFAULT";
})(BAR_STYLE || (BAR_STYLE = {}));
class BarPlugin extends InsetsPlugin {
  setColor(color) {
...
var _a$4;
class StatusBarPlugin extends BarPlugin {
  constructor() {
  ...
  async setState(state) {
    await this.commonSetState({
      ...state,
      color: state.color ? convertColorToArga(state.color) : void 0
    });
  }
...
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", [typeof (_a$4 = typeof K !== "undefined" && K) === "function" ? _a$4 : Object, Object]),
  __metadata("design:returntype", void 0)
], StatusBarPlugin.prototype, "setStateByKey", null);
const statusBarPlugin = new StatusBarPlugin();
var _HTMLStateObserverElement_onStateChange;
class HTMLStateObserverElement extends HTMLElement {
  constructor(state) {
    super();
  ...
  async disconnectedCallback() {
    if (__classPrivateFieldGet(this, _HTMLStateObserverElement_onStateChange, "f")) {
      ...
      __classPrivateFieldSet(this, _HTMLStateObserverElement_onStateChange, void 0, "f");
    }
    await this.state.stopObserve();
  }
}
_HTMLStateObserverElement_onStateChange = /* @__PURE__ */ new WeakMap();
class HTMLDwebStatusBarElement extends HTMLStateObserverElement {
  constructor() {
...
var _a$3;
class NavigationBarPlugin extends BarPlugin {
  constructor() {
...
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", [typeof (_a$3 = typeof K !== "undefined" && K) === "function" ? _a$3 : Object, Object]),
  __metadata("design:returntype", void 0)
], NavigationBarPlugin.prototype, "setStateByKey", null);
const navigationBarPlugin = new NavigationBarPlugin();
class HTMLDwebNavigationBarElement extends HTMLStateObserverElement {
  constructor() {
...
var _a$2;
class SafeAreaPlugin extends InsetsPlugin {
  constructor() {
...
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", [typeof (_a$2 = typeof K !== "undefined" && K) === "function" ? _a$2 : Object, Object]),
  __metadata("design:returntype", void 0)
...
const safeAreaPlugin = new SafeAreaPlugin();
class HTMLDwebSafeAreaElement extends HTMLStateObserverElement {
  constructor() {
...
__decorate([
  ...
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebSafeAreaElement.prototype, "getState", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
...
var _a;
class VirtualKeyboardPlugin extends InsetsPlugin {
  constructor() {
...
const virtualKeyboardPlugin = new VirtualKeyboardPlugin();
...
customElements.define(virtualKeyboardPlugin.tagName, HTMLDwebVirtualKeyboardElement);
...
const splashScreenPlugin = new SplashScreenPlugin();
...
__decorate([
  ...
  __metadata("design:paramtypes", [Object]),
  __metadata("design:returntype", Promise)
], CameraPlugin.prototype, "getPhoto", null);
...
class BarcodeScannerPlugin extends BasePlugin {
  constructor() {
    ...
    Object.defineProperty(this, "tagName", {
      ...
      configurable: true,
      writable: true,
      value: "dweb-barcode-scanning"
    });
  }
  async process(blob, rotation = 0, formats = SupportedFormat.QR_CODE) {
...
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", [Blob, Object, Object]),
  __metadata("design:returntype", Promise)
], BarcodeScannerPlugin.prototype, "process", null);
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", []),
...
__decorate([
  ...
  __metadata("design:paramtypes", [Object]),
  __metadata("design:returntype", void 0)
], BarcodeScannerPlugin.prototype, "getPhoto", null);
...
class PromiseOut {
  constructor() {
    ...
    Object.defineProperty(this, "promise", {
      ...
      configurable: true,
      writable: true,
      value: new Promise((resolve2, reject) => {
...
var _CloseWatcher_instances, _CloseWatcher_id, _CloseWatcher_init, _CloseWatcher_onclose;
const native_close_watcher_kit = globalThis.__native_close_watcher_kit__;
if (native_close_watcher_kit) {
  (_c = native_close_watcher_kit._watchers) != null ? _c : native_close_watcher_kit._watchers = /* @__PURE__ */ new Map();
  (_d = native_close_watcher_kit._tasks) != null ? _d : native_close_watcher_kit._tasks = /* @__PURE__ */ new Map();
}
class CloseWatcher extends EventTarget {
  constructor() {
    super();
    _CloseWatcher_instances.add(this);
    _CloseWatcher_id.set(this, new PromiseOut());
    ...
    _CloseWatcher_onclose.set(this, void 0);
    void __classPrivateFieldGet(this, _CloseWatcher_instances, "m", _CloseWatcher_init).call(this);
  }
  async close() {
    if (this._closed) {
      return;
    }
    const id = await __classPrivateFieldGet(this, _CloseWatcher_id, "f").promise;
    native_close_watcher_kit.tryClose(id);
  }
  get onclose() {
    var _a3;
    return (_a3 = __classPrivateFieldGet(this, _CloseWatcher_onclose, "f")) != null ? _a3 : null;
  }
  set onclose(value) {
    if (typeof value === "function") {
      __classPrivateFieldSet(this, _CloseWatcher_onclose, value, "f");
    } else {
      __classPrivateFieldSet(this, _CloseWatcher_onclose, void 0, "f");
    }
  }
  addEventListener() {
...
_CloseWatcher_id = /* @__PURE__ */ new WeakMap(), _CloseWatcher_onclose = /* @__PURE__ */ new WeakMap(), _CloseWatcher_instances = /* @__PURE__ */ new WeakSet(), _CloseWatcher_init = async function _CloseWatcher_init2() {
  const token = URL.createObjectURL(new Blob(["create-close-watcher"], { type: "text/html" }));
  const tasks = native_close_watcher_kit._tasks;
  const po = __classPrivateFieldGet(this, _CloseWatcher_id, "f");
  ...
  this.addEventListener("close", (event) => {
    ...
    (_a3 = __classPrivateFieldGet(this, _CloseWatcher_onclose, "f")) == null ? void 0 : _a3.call(this, event);
...
const torchPlugin = new TorchPlugin();
class HTMLDwebBarcodeScanningElement extends HTMLElement {
  constructor() {
    super();
    Object.defineProperty(this, "plugin", {
      enumerable: true,
  ...
  get getView() {
    var _a3;
    return (_a3 = this._video) == null ? void 0 : _a3.parentElement;
  }
  get process() {
  ...
  taskPhoto(rotation, formats) {
    this._activity = true;
    return new Promise((resolve2, reject) => {
      const task = () => {
        if (!this._canvas)
          return reject("service close\uFF01");
        if (!this._activity)
          return reject("user close");
        this._canvas.toBlob(
          async (imageBlob) => {
            if (imageBlob) {
              const value = await this.plugin.process(imageBlob, rotation, formats).then((res) => res.json()).catch(() => {
                this._activity = false;
  ...
  async _startVideo() {
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
      ...
      await navigator.mediaDevices.getUserMedia(constraints).then((stream) => {
        ...
        throw new Error("You need to authorize the camera permission to use the scan code!");
      });
    } else {
  ...
  gotMedia(mediastream) {
    ...
    if (videoTracks.length > 0 && this._canvas) {
      ...
      (_a3 = this._video.parentElement) == null ? void 0 : _a3.setAttribute("style", `
      ...
      const update = () => requestAnimationFrame(() => {
        var _a4, _b2, _c2, _d2;
        if (ctx && this._video) {
          ctx.drawImage(this._video, 0, 0, (_b2 = (_a4 = this._canvas) == null ? void 0 : _a4.width) != null ? _b2 : 480, (_d2 = (_c2 = this._canvas) == null ? void 0 : _c2.height) != null ? _d2 : 360);
          update();
        }
      });
      update();
  ...
  _stop() {
    ...
    if (this._video) {
      ...
      (_a3 = this._video.parentElement) == null ? void 0 : _a3.remove();
      this._video = null;
    }
    if (this._canvas) {
      (_b2 = this._canvas.getContext("2d")) == null ? void 0 : _b2.clearRect(0, 0, this._canvas.width, this._canvas.height);
      this._canvas = null;
    }
  }
  createElement(direction = CameraDirection.BACK) {
    ...
    parent.setAttribute("style", "position:fixed; top: 0; left: 0; width:100%; height: 100%; background-color: black;visibility: hidden;");
...
__decorate([
  ...
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBarcodeScanningElement.prototype, "getView", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBarcodeScanningElement.prototype, "process", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBarcodeScanningElement.prototype, "stop", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBarcodeScanningElement.prototype, "toggleTorch", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBarcodeScanningElement.prototype, "getTorchState", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBarcodeScanningElement.prototype, "getPhoto", null);
...
class HapticsPlugin extends BasePlugin {
  ...
  async vibrate(options) {
    const duration = (options == null ? void 0 : options.duration) || 300;
...
const hapticsPlugin = new HapticsPlugin();
...
var BiometricsTypes;
(function(BiometricsTypes2) {
  BiometricsTypes2["fingerprint"] = "fingerprint";
  BiometricsTypes2["faceRecognition"] = "faceRecognition";
})(BiometricsTypes || (BiometricsTypes = {}));
class BiometricsPlugin extends BasePlugin {
  constructor() {
  ...
  async check(type) {
    return await this.fetchApi("/check", {
      search: {
        type
      }
    }).boolean();
  ...
  async fingerprint() {
    return await this.fetchApi("/fingerprint").boolean();
  }
}
__decorate([
  bindThis,
...
__decorate([
  ...
  __metadata("design:paramtypes", []),
  __metadata("design:returntype", Promise)
], BiometricsPlugin.prototype, "fingerprint", null);
const biometricsPlugin = new BiometricsPlugin();
class HTMLDwebBiometricsElement extends HTMLElement {
  get chuck() {
    return biometricsPlugin.check;
  }
  get fingerprint() {
    return biometricsPlugin.fingerprint;
  }
}
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBiometricsElement.prototype, "chuck", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], HTMLDwebBiometricsElement.prototype, "fingerprint", null);
class DwebServiceWorkerPlugin extends BasePlugin {
  constructor() {
    super("dns.sys.dweb");
    Object.defineProperty(this, "tagName", {
      enumerable: true,
    ...
    Object.defineProperty(this, "updateController", {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new UpdateControllerPlugin()
    });
  }
  update() {
...
__decorate([
  ...
  __metadata("design:paramtypes", []),
  __metadata("design:returntype", void 0)
], DwebServiceWorkerPlugin.prototype, "update", null);
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", []),
...
class UpdateControllerPlugin extends BasePlugin {
  constructor() {
    ...
    Object.defineProperty(this, "progressNum", {
      enumerable: true,
      configurable: true,
      writable: true,
      value: 0
...
__decorate([
  ...
  __metadata("design:paramtypes", []),
  __metadata("design:returntype", Promise)
], UpdateControllerPlugin.prototype, "pause", null);
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", []),
  __metadata("design:returntype", Promise)
], UpdateControllerPlugin.prototype, "resume", null);
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", []),
  __metadata("design:returntype", Promise)
], UpdateControllerPlugin.prototype, "cancel", null);
__decorate([
  bindThis,
  __metadata("design:type", Function),
  __metadata("design:paramtypes", []),
  __metadata("design:returntype", Promise)
], UpdateControllerPlugin.prototype, "getMMid", null);
const dwebServiceWorkerPlugin = new DwebServiceWorkerPlugin();
globalThis.__app_upgrade_watcher_kit__ = {};
const app_upgrade_watcher_kit = globalThis.__app_upgrade_watcher_kit__;
if (app_upgrade_watcher_kit) {
  (_e = app_upgrade_watcher_kit._listeners) != null ? _e : app_upgrade_watcher_kit._listeners = {};
  (_f = app_upgrade_watcher_kit._windowListeners) != null ? _f : app_upgrade_watcher_kit._windowListeners = {};
}
class BaseEvent extends EventTarget {
  addEventListener(eventName, listenerFunc, options) {
    ...
    const remove2 = () => this.removeEventListener(eventName, listenerFunc);
...
class DwebServiceWorker extends BaseEvent {
  constructor() {
    super(...arguments);
    Object.defineProperty(this, "updateContoller", {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new UpdateController()
    });
  }
  get update() {
...
__decorate([
  ...
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], DwebServiceWorker.prototype, "update", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
...
class UpdateController extends BaseEvent {
  get download() {
...
__decorate([
  ...
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], UpdateController.prototype, "download", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], UpdateController.prototype, "pause", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], UpdateController.prototype, "resume", null);
__decorate([
  cacheGetter(),
  __metadata("design:type", Object),
  __metadata("design:paramtypes", [])
], UpdateController.prototype, "cancel", null);
const dwebServiceWorker = new DwebServiceWorker();
if (typeof globalThis["DwebServiceWorker"] === "undefined") {
  Object.assign(globalThis, { DwebServiceWorker });
}
if (typeof globalThis["UpdateController"] === "undefined") {
...
class FetchEvent extends Event {
  constructor(type, init) {
    ...
    Object.defineProperty(this, "waitUntilPromise", {
      enumerable: true,
      configurable: true,
      writable: true,
      value: void 0
...
class OnFetchEvent extends Event {
  constructor(type = "onfetch", init) {
    super(type);
    Object.defineProperty(this, "type", {
      enumerable: true,
      configurable: true,
...
if (typeof dntGlobalThis["FetchEvent"] === "undefined") {
  Object.assign(dntGlobalThis, { FetchEvent });
}
if (typeof dntGlobalThis["OnFetchEvent"] === "undefined") {
  Object.assign(dntGlobalThis, { OnFetchEvent });
}
...
const routes = [
  { title: "Status Bar", path: "/statusbar", component: () => __vitePreload(() => import("./StatusBar.29c66b65.js"), true ? ["assets/StatusBar.29c66b65.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css","assets/VColorPicker.a712b1c6.js","assets/VColorPicker.a39f3ee8.css"] : void 0) },
  { title: "Navigation Bar", path: "/navigationbar", component: () => __vitePreload(() => import("./NavigationBar.acfa9171.js"), true ? ["assets/NavigationBar.acfa9171.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css","assets/VColorPicker.a712b1c6.js","assets/VColorPicker.a39f3ee8.css"] : void 0) },
  { title: "Safe Area", path: "/safearea", component: () => __vitePreload(() => import("./SafeArea.f3a5871f.js"), true ? ["assets/SafeArea.f3a5871f.js","assets/SafeArea.b5dc5e7d.css","assets/safearea.d6166183.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Virtual Keyboard", path: "/virtualkeyboard", component: () => __vitePreload(() => import("./VirtualKeyboard.929cd963.js"), true ? ["assets/VirtualKeyboard.929cd963.js","assets/VirtualKeyboard.a6f27424.css","assets/safearea.d6166183.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Toast", path: "/toast", component: () => __vitePreload(() => import("./Toast.47c6f948.js"), true ? ["assets/Toast.47c6f948.js","assets/toast.7a5f524e.js","assets/FieldLabel.e4aa2d01.js","assets/FieldLabel.72137d27.css","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Share", path: "/share", component: () => __vitePreload(() => import("./Share.f29f0050.js"), true ? ["assets/Share.f29f0050.js","assets/FieldLabel.e4aa2d01.js","assets/FieldLabel.72137d27.css","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Splash Screen", path: "/splashscreen", component: () => __vitePreload(() => import("./SplashScreen.829e44d3.js"), true ? ["assets/SplashScreen.829e44d3.js","assets/splashscreen.ecee76e9.js","assets/FieldLabel.e4aa2d01.js","assets/FieldLabel.72137d27.css","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Barcode Scanning", path: "/barcodescanning", component: () => __vitePreload(() => import("./BarcodeScanning.cea57fbc.js"), true ? ["assets/BarcodeScanning.cea57fbc.js","assets/vibrate.d24dcb2b.js","assets/FieldLabel.e4aa2d01.js","assets/FieldLabel.72137d27.css","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Torch", path: "/torch", component: () => __vitePreload(() => import("./Torch.2640e0fd.js"), true ? ["assets/Torch.2640e0fd.js","assets/toast.7a5f524e.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Haptics", path: "/haptics", component: () => __vitePreload(() => import("./Haptics.7b84fec4.js"), true ? ["assets/Haptics.7b84fec4.js","assets/vibrate.d24dcb2b.js","assets/FieldLabel.e4aa2d01.js","assets/FieldLabel.72137d27.css","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Close Watcher", path: "/closewatcher", component: () => __vitePreload(() => import("./CloseWatcher.6774600e.js"), true ? ["assets/CloseWatcher.6774600e.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) },
  { title: "Dweb ServiceWorker", path: "/serviceworker", component: () => __vitePreload(() => import("./DwebServiceWorker.5dc584f2.js"), true ? ["assets/DwebServiceWorker.5dc584f2.js","assets/splashscreen.ecee76e9.js","assets/LogPanel.fb338927.js","assets/LogPanel.a2d8e52a.css"] : void 0) }
];
...
function propIsDefined(vnode, prop) {
  var _a3, _b2;
  return typeof ((_a3 = vnode.props) == null ? void 0 : _a3[prop]) !== "undefined" || typeof ((_b2 = vnode.props) == null ? void 0 : _b2[toKebabCase(prop)]) !== "undefined";
}
  ...
  if (options._setup) {
    ...
    options.setup = function setup(props, ctx) {
      ...
      const componentDefaults = computed(() => {
        var _a4;
        return defaults.value[(_a4 = props._as) != null ? _a4 : options.name];
      });
      const _props = new Proxy(props, {
        get(target, prop) {
          var _a4, _b3, _c2, _d2;
          if (typeof prop === "string" && !propIsDefined(vm.vnode, prop)) {
            return (_d2 = (_c2 = (_a4 = componentDefaults.value) == null ? void 0 : _a4[prop]) != null ? _c2 : (_b3 = defaults.value.global) == null ? void 0 : _b3[prop]) != null ? _d2 : target[prop];
          }
      ...
      useToggleScope(_subcomponentDefaults, () => {
        var _a4, _b3;
        provideDefaults(mergeDeep((_b3 = (_a4 = injectSelf(DefaultsSymbol)) == null ? void 0 : _a4.value) != null ? _b3 : {}, _subcomponentDefaults.value));
      });
...
function provideTheme(props) {
  ...
  const name = computed(() => {
    var _a3;
    return (_a3 = props.theme) != null ? _a3 : theme == null ? void 0 : theme.name.value;
  });
...
function useProxiedModel(props, prop, defaultValue) {
  ...
  const isControlled = checkKebab ? computed(() => {
    var _a3, _b2, _c2, _d2;
    void props[prop];
    return !!((((_a3 = vm.vnode.props) == null ? void 0 : _a3.hasOwnProperty(prop)) || ((_b2 = vm.vnode.props) == null ? void 0 : _b2.hasOwnProperty(kebabProp))) && (((_c2 = vm.vnode.props) == null ? void 0 : _c2.hasOwnProperty(`onUpdate:${prop}`)) || ((_d2 = vm.vnode.props) == null ? void 0 : _d2.hasOwnProperty(`onUpdate:${kebabProp}`))));
  }) : computed(() => {
    var _a3, _b2;
    void props[prop];
    return !!(((_a3 = vm.vnode.props) == null ? void 0 : _a3.hasOwnProperty(prop)) && ((_b2 = vm.vnode.props) == null ? void 0 : _b2.hasOwnProperty(`onUpdate:${prop}`)));
  });
...
function createVuetifyAdapter(options) {
  var _a3, _b2;
  const current = ref((_a3 = options == null ? void 0 : options.locale) != null ? _a3 : "en");
...
function createRtl(i18n, options) {
  var _a3;
  const rtl = ref((_a3 = options == null ? void 0 : options.rtl) != null ? _a3 : defaultRtl);
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode(props.tag, {
      ...
      default: () => {
        ...
        }, [(_a3 = slots.default) == null ? void 0 : _a3.call(slots)]) : (_b2 = slots.default) == null ? void 0 : _b2.call(slots)];
      }
    }));
    return {};
  }
});
const _withScopeId = (n) => (pushScopeId("data-v-74ea4c5d"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "h-full drawer app-bg" };
const _hoisted_2 = { class: "flex flex-col drawer-content" };
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "navbar" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "flex-none" }, [
  ...
  /* @__PURE__ */ createBaseVNode("div", { class: "flex-1" }, [
    /* @__PURE__ */ createBaseVNode("h1", { class: "text-xl" }, "JMM Plugins Demo")
  ]),
  /* @__PURE__ */ createBaseVNode("div", { class: "flex-none" }, [
    /* @__PURE__ */ createBaseVNode("button", { class: "btn btn-square btn-ghost" }, [
      /* @__PURE__ */ createBaseVNode("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 24 24",
...
const _hoisted_7 = { class: "p-4 bg-opacity-50 menu w-80 glass bg-base-100" };
const _sfc_main = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_dweb_config = resolveComponent("dweb-config");
      const _component_router_view = resolveComponent("router-view");
      const _component_router_link = resolveComponent("router-link");
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_dweb_config, { "api-url": unref(apiUrl) }, null, 8, ["api-url"]),
...
var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-74ea4c5d"]]);
var app = "";
var main = "";
...
function inject(key) {
  var _a3, _b2, _c2;
  const vm = this.$;
  const provides = (_c2 = (_a3 = vm.parent) == null ? void 0 : _a3.provides) != null ? _c2 : (_b2 = vm.vnode.appContext) == null ? void 0 : _b2.provides;
  if (provides && key in provides) {
    return provides[key];
  }
}
...
createApp(App).use(createVuetify({})).use(
  createRouter({
    history: createWebHashHistory(),
    routes
  })
).mount("#app");
export { useIcon as $, getCurrentInstanceName as A, destructComputed as B, isCssColor as C, makeTagProps as D, makeThemeProps as E, Fragment as F, genericComponent as G, provideTheme as H, provideDefaults as I, toRef as J, pick as K, getCurrentInstance as L, getUid as M, provide as N, inject$1 as O, onBeforeUnmount as P, reactive as Q, useProxiedModel as R, deepEqual as S, TransitionGroup as T, wrapInArray as U, findChildrenWithProvide as V, consoleWarn as W, mergeProps as X, toRefs as Y, IconValue as Z, Text as _, createVNode as a, SUPPORTS_INTERSECTION as a0, watchEffect as a1, isObject as a2, keyCodes as a3, useRtl as a4, resolveDynamicComponent as a5, hasEvent as a6, nextTick as a7, resolveDirective as a8, HSVtoRGB as a9, RGBtoHSV as aa, HSVtoHSL as ab, HSLtoHSV as ac, HSVtoHex as ad, HexToHSV as ae, parseHex as af, Transition as ag, h as ah, camelize as ai, onBeforeMount as aj, useToggleScope as ak, useLocale as al, EventProp as am, isOn as an, createRange as ao, vShow as ap, keyValues as aq, HSVtoCSS as ar, getContrast as as, vModelText as at, _export_sfc as au, toDisplayString as av, renderSlot as aw, barcodeScannerPlugin as ax, CloseWatcher as ay, dwebServiceWorker as az, createBaseVNode as b, createElementBlock as c, defineComponent$1 as d, vModelCheckbox as e, resolveComponent as f, openBlock as g, withCtx as h, renderList as i, isRef as j, includes as k, defineComponent as l, computed as m, normalizeClass as n, onMounted as o, convertToUnit as p, useResizeObserver as q, ref as r, watch as s, clamp as t, unref as u, vModelSelect as v, withDirectives as w, useRender as x, getEventCoordinates as y, propsFactory as z };

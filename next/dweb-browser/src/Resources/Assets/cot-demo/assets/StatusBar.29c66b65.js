...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("h2", { class: "card-title" }, "Status Bar Background Color", -1);
const _hoisted_4 = { class: "justify-end card-actions btn-group" };
const _hoisted_5 = ["disabled"];
const _hoisted_6 = { class: "card-body" };
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("h2", { class: "card-title" }, "Status Bar Style", -1);
...
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("h2", { class: "card-title" }, "Status Bar Overlays WebView", -1);
const _hoisted_16 = { class: "justify-end card-actions btn-group" };
const _hoisted_17 = ["disabled"];
const _hoisted_18 = { class: "card-body" };
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("h2", { class: "card-title" }, "Status Bar Visible", -1);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onStatusBarChange = (info, type) => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_dweb_status_bar, {
          ref_key: "$statusBar",
          ref: $statusBar,
          onStatechange: _cache[0] || (_cache[0] = ($event) => onStatusBarChange($event.detail, "change"))
        }, null, 512),

...
namespace DwebBrowser.Platforms.iOS.MicroModule.NativeUI.NavigationBar
{
	public class NavigationBarNMM: NativeMicroModule
	{
        ...
        private Task<NavigationBarController> _getControllerAsync(Mmid mmid) =>
        MainThread.InvokeOnMainThreadAsync(() => NativeUiController.FromMultiWebView(mmid).NavigationBar);
